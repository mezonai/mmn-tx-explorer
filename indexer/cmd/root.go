...
func init() {
	...
	rootCmd.PersistentFlags().Int("stats-worker-interval", 5, "Stats recalculation interval in minutes")
	...
	viper.BindPFlag("statsWorker.intervalMinutes", rootCmd.PersistentFlags().Lookup("stats-worker-interval"))
