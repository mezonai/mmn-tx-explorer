...
// GetCampaignWallets provides a mock function with given fields: ctx
func (_m *MockIMainStorage) GetCampaignWallets(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetCampaignWallets")
	}
...
// MockIMainStorage_GetCampaignWallets_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCampaignWallets'
type MockIMainStorage_GetCampaignWallets_Call struct {
	*mock.Call
}

// GetCampaignWallets is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockIMainStorage_Expecter) GetCampaignWallets(ctx interface{}) *MockIMainStorage_GetCampaignWallets_Call {
	return &MockIMainStorage_GetCampaignWallets_Call{Call: _e.mock.On("GetCampaignWallets", ctx)}
}

func (_c *MockIMainStorage_GetCampaignWallets_Call) Run(run func(ctx context.Context)) *MockIMainStorage_GetCampaignWallets_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockIMainStorage_GetCampaignWallets_Call) Return(_a0 []string, _a1 error) *MockIMainStorage_GetCampaignWallets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockIMainStorage_GetCampaignWallets_Call) RunAndReturn(run func(context.Context) ([]string, error)) *MockIMainStorage_GetCampaignWallets_Call {
	_c.Call.Return(run)
	return _c
}
