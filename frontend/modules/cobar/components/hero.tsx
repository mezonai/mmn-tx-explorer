      ...
      <div className="flex flex-col items-stretch justify-between gap-4 lg:flex-row lg:gap-2">
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex flex-col gap-3 p-4 sm:flex-row">
            <Button
              variant="default"
              className="dark:bg-brand-primary dark:text-foreground sm:text-md dark:hover:bg-brand-primary/70 w-full py-5 text-sm font-semibold sm:w-auto"
            >
              <Link
                href="https://cobar.vn"
                target="_blank"
        ...
        <div className="flex flex-1 flex-col">
          <Card
            ...
            className="dark:bg-background bg-brand-primary/3 h-full"
          >
            <Button
              variant="default"
              className="dark:bg-brand-primary dark:text-foreground dark:hover:bg-brand-primary/70 w-full sm:w-auto"
            >
