...
export const EcoCard = ({
  ...
  return (
    <Link
      ...
      className={cn(
        `bg-card ${comingSoon ? 'cursor-default' : 'hover:border-primary/50 dark:hover:border-primary/50 cursor-pointer'} block rounded-xl border border-gray-300 p-6 shadow-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand-link)] dark:border-gray-700 dark:bg-slate-800 dark:shadow-sm ${className}`
      )}
    >
