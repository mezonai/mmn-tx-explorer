...
const file_proto_tx_proto_rawDesc = "" +
	...
	"\vGetTxByHash\x12\x17.mmn.GetTxByHashRequest\x1a\x18.mmn.GetTxByHashResponseB\x1aZ\x18dong-service/proto;protob\x06proto3"
...
var file_proto_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_proto_tx_proto_depIdxs = []int32{
	...
	3, // 4: mmn.TxService.AddTx:input_type -> mmn.SignedTxMsg
	5, // 5: mmn.TxService.GetTxByHash:input_type -> mmn.GetTxByHashRequest
	4, // 6: mmn.TxService.AddTx:output_type -> mmn.AddTxResponse
	7, // 7: mmn.TxService.GetTxByHash:output_type -> mmn.GetTxByHashResponse
