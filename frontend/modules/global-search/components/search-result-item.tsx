...
export const SearchResultItem = ({ href, icon: Icon, title, timestamp }: SearchResultItemProps) => {
  return (
    <Link
      href={href}
      className="focus:bg-brand-primary active:bg-brand-primary hover:bg-sidebar-accent flex flex-col items-start justify-between gap-1 rounded p-2 lg:flex-row lg:items-center lg:gap-2"
    >
